...
void Button::Render(SDL_Rect* currentClip, SDL_Renderer* gRenderer, TextureManager gButtonTextureManager)
{
    gButtonTextureManager.Render(position.x, position.y, gRenderer, currentClip);
}
